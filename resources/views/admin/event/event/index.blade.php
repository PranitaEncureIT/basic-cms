                           ...
                           <tr>
                              ...
                              <td>
                                ...
                                @if (file_exists($imagePath) && !empty($event->image))
                                    <img src="{{ asset('/assets/front/img/events/sliders/' .$event->image) }}"
                                    alt="Image">
                                @else
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.event.store')}}" method="POST">
               @csrf
                ...
                <div class="form-group">
                    ...
                    <input id="fileInput2" type="file" name="video" accept="video/*"
                    style="display: none;">
                    <!-- Label acting as the button triggers the file input -->
                    <label for="fileInput2" class="choose-image btn btn-primary">Choose Video</label>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input id="fileInput1" type="file" name="slider" accept="image/*"
...
<script>
    document.getElementById('fileInput2').addEventListener('change', function (event) {
        ...
        if (input.files && input.files[0]) {
            ...
            const videoPreview = document.getElementById('videoPreview2');
            ...
            videoTag.load(); // Reload the video element to reflect changes
            videoTag.play(); // Optionally autoplay the video after selection
        }
    });
  </script>
