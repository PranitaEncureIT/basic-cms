            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.scategory.index') . '?language=' . request()->input('language') }}">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.scategory.update') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview" id="thumbPreview1">
                                        ...
                                        <img src="{{ asset('cms/scategory/' . $scategory->image) }}" alt="User Image">
                                      @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $scategory->name }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="short_text"
                                        value="{{ $scategory->short_text }}" placeholder="Enter short text">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control ltr" name="serial_number"
                                        value="{{ $scategory->serial_number }}" placeholder="Enter Serial Number">
                                    <p id="errserial_number" class="mb-0 text-danger em"></p>
                                    <p class="text-warning"><small>The higher the serial number is, the later the service
                                            category will be shown everywhere.</small></p>
                                </div>
                            </form>
                        </div>
                    </div>
