                                        ...
                                        <tbody>
                                            @foreach ($services as $key => $service)
                                                <tr>
                                                    ...
                                                    <td>{{ strlen(convertUtf8($service->title)) > 100 ? convertUtf8(substr($service->title, 0, 100)) . '...' : convertUtf8($service->title) }}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <form id="featureForm{{ $service->id }}" class="d-inline-block"
                                                            action="{{ route('admin.service.feature') }}" method="post">
                                                            @csrf
                                                            <input type="hidden" name="service_id"
                                                                value="{{ $service->id }}">
                                                            <select
                                                                class="form-control {{ $service->feature == 1 ? 'bg-success' : 'bg-danger' }}"
                                                                name="feature"
                                                                onchange="document.getElementById('featureForm{{ $service->id }}').submit();">
                                                                <option value="1"
                                                                    {{ $service->feature == 1 ? 'selected' : '' }}>Yes
                                                                </option>
                                                                <option value="0"
                                                                    {{ $service->feature == 0 ? 'selected' : '' }}>No
                                                                </option>
                                                            </select>
                                                        </form>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <form id="statusForm{{ $service->id }}" class="d-inline-block"
                                                            action="{{ route('admin.service.sidebar') }}" method="post">
                                                            @csrf
                                                            <input type="hidden" name="service_id"
                                                                value="{{ $service->id }}">
                                                            <select
                                                                class="form-control form-control-sm
                                                @if ($service->sidebar == 1) bg-success
                                                ...
                                                "
                                                                ...
                                                                <option value="1"
                                                                    {{ $service->sidebar == 1 ? 'selected' : '' }}>Enabled
                                                                </option>
                                                                <option value="0"
                                                                    {{ $service->sidebar == 0 ? 'selected' : '' }}>Disabled
                                                                </option>
                                                            </select>
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.service.edit', $service->id) . '?language=' . request()->input('language') }}">
                ...
                <div class="modal-body">
                    <form id="ajaxForm" class="modal-form" action="{{ route('admin.service.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="fileInput1" type="file" name="image" name="image" accept="image/*"
                                style="display: none;">
