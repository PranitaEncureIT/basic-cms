                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.product.store') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview" id="thumbPreview1">
                                        <img src="{{ asset('assets/front/img/no_image.jpg') }}" alt="Feature Image">
                                    </div>
                                    <br>
                                    <br>
                                        ...
                                        @if ($type == 'physical')
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control ltr" name="stock"
                                                    value="" placeholder="Enter Product Stock">
                                ...
                                @if ($bex->catalog_mode == 0)
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for=""> Current Price (in {{ $abx->base_currency_text }})
                                                    **</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="">Previous Price (in
                                                    {{ $abx->base_currency_text }})</label>
