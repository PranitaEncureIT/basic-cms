        ...
        <div class="sidebar-content">
          ...
          @elseif(request()->path() == 'admin/home-page') active @endif">
            ...
            @elseif(request()->path() == 'admin/home-page') show @endif"
                ...
                @canany(['mega_menu', 'main_menu', 'permalinks'])
                    {{-- Menu Builder --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->path() == 'admin/permalinks') active @endif">
            ...
            @elseif(request()->path() == 'admin/megamenus/edit') show @endif"
                ...
                {{-- Content Management --}}
                @canany(['sections_customization', 'partners', 'blogs', 'team_section', 'testimonials', 'portfolios', 'package_background',
                    'call_to_action_section', 'statistics_section', 'approach_section', 'services', 'intro_section',
                    'features', 'static_version', 'slider_version', 'video_version', 'logo_and_text', 'useful_links',
                    'department_links', 'about_us', 'settings_services', 'scategory', 'services', 'portfolios', 'bcategory',
                    'blogs', 'archives', 'gallery_settings', 'gallery_categories', 'gallery', 'faq_settings',
                    'faq_categories', 'faqs', 'jcategories', 'job_management'])
                    @includeIf('admin.partials.content-management')
                @endcanany

                @canany(['pages_settings', 'create_page', 'pages'])
                    {{-- Dynamic Pages --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->is('admin/page/*/edit')) active @endif">
            ...
            @elseif(request()->is('admin/page/*/edit')) show @endif"
                ...
                @can('event_calender')
                    {{-- Event Calendar --}}
                    <li class="nav-item
          @if (request()->path() == 'admin/calendars') active @endif">
                ...
                {{-- Package Management --}}
                @canany(['package_settings', 'package_categories', 'package_form_builder', 'packages', 'subscriptions'])
          ...
          @elseif(request()->path() == 'admin/package/order/report') active @endif">
            ...
            @elseif(request()->path() == 'admin/package/order/report') show @endif"
                            id="packages">
                            <ul class="nav nav-collapse">
                                @can('package_settings')
                                ...
                                @can('package_form_builder')
                                    <li
                                        class="@if (request()->path() == 'admin/package/form') active
                @elseif(request()->is('admin/package/*/inputEdit')) active @endif">
                ...
                @elseif(request()->routeIs('admin.package.edit')) active @endif">
                                ...
                                @if ($bex->recurring_billing == 1)
                                    @can('subscriptions')
                                        <li class="submenu">
                                            ...
                                            <div class="collapse @if (request()->routeIs('admin.subscriptions') && request()->input('type') != 'request') show @endif"
                                                id="manageSubscriptions" style="">
                                ...
                                @if ($bex->recurring_billing == 0)
                                    <li class="submenu">
                                        ...
                                        <div class="collapse {{ request()->path() == 'admin/all/orders' || request()->path() == 'admin/pending/orders' || request()->path() == 'admin/processing/orders' || request()->path() == 'admin/completed/orders' || request()->path() == 'admin/package/order/report' ? 'show' : '' }}"
                                            id="packageOrders" style="">
                                            <ul class="nav nav-collapse subnav">
                ...
                @canany(['visibility', 'form_builder', 'all_quotes', 'pending_quotes', 'processing_quotes',
                    'completed_quotes', 'rejected_quotes'])
          ...
          @elseif(request()->path() == 'admin/quote/visibility') active @endif">
            ...
            @elseif(request()->path() == 'admin/quote/visibility') show @endif"
                            id="quote">
                            <ul class="nav nav-collapse">
                                @can('visibility')
                                    <li class="
                @if (request()->path() == 'admin/quote/visibility') active @endif">
                                ...
                                @can('form_builder')
                                    <li
                                        class="
                @if (request()->path() == 'admin/quote/form') active
                @elseif(request()->is('admin/quote/*/inputEdit')) active @endif">
                ...
                @canany(['shop_settings', 'popular_tags', 'shipping_charges', 'coupons'])
                    {{-- Product --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->path() == 'admin/product/orders/report') active @endif">
            ...
            @elseif(request()->path() == 'admin/product/orders/report') show @endif"
                ...
                @elseif(request()->routeIs('admin.coupon.edit')) active @endif">
                  ...
                  @elseif(request()->routeIs('admin.product.edit')) show @endif"
                      ...
                      @elseif(request()->is('admin/product/*/edit')) active @endif">
                                ...
                                @canany(['all_orders', 'pending_orders', 'processing_orders', 'completed_orders',
                                    'rejected_orders', 'order_report'])
                                    @if ($bex->catalog_mode == 0)
                                        <li class="submenu">
                ...
                @canany(['course_settings', 'course_categories', 'courses', 'enrolls', 'course_report'])
                    {{-- Courses --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->path() == 'admin/course/enrolls/report') active @endif">
            ...
            @elseif(request()->path() == 'admin/course/enrolls/report') show @endif"
                ...
                {{-- Events Manage --}}
                @canany(['event_settings', 'event_categories', 'all_events', 'bookings', 'event_report'])
                    <li
                        class="nav-item
          ...
          @elseif(request()->path() == 'admin/events/report') active @endif">
            ...
            @elseif(request()->path() == 'admin/events/report') show @endif"
                ...
                @canany(['donation_settings', 'all_causes', 'donations', 'donation_report'])
                    <li
                        class="nav-item
          ...
          @elseif(request()->path() == 'admin/donation/report') active @endif">
            ...
            @elseif(request()->path() == 'admin/donation/report') show @endif"
                            id="donation_manage">
                            <ul class="nav nav-collapse">
                                @can('donation_settings')
                                ...
                                @can('all_causes')
                                    <li
                                        class="
                @if (request()->path() == 'admin/donations') active
                @elseif(request()->is('admin/donation/*/edit')) active @endif">
                ...
                {{-- Knowledgebase --}}
                @canany(['article_categories', 'articles'])
                    {{-- Articles --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->is('admin/article/*/edit')) active @endif">
            ...
            @elseif(request()->is('admin/article/*/edit')) show @endif"
                ...
                @canany(['ticket_settings', 'all_tickets', 'pending_tickets', 'open_tickets', 'closed_tickets'])
                    {{-- Tickets --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->routeIs('admin.ticket.settings')) active @endif">
            ...
            @elseif(request()->routeIs('admin.ticket.settings')) show @endif"
                            id="tickets">
                            <ul class="nav nav-collapse">
                                @can('ticket_settings')
                ...
                @canany(['import_rss_feeds', 'rss_feeds', 'rss_posts'])
                    {{-- RSS --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->is('admin/rss/edit/*')) active @endif">
            ...
            @elseif(request()->is('admin/rss/edit/*')) show @endif"
                ...
                {{-- Users Management --}}
                @canany(['registered_users', 'notification_settings', 'subscribers'])
          ...
          @elseif(request()->path() == 'admin/popups') active @endif">
            ...
            @elseif(request()->is('admin/popup/*/edit')) show @endif"
                ...
                @canany(['general_settings', 'file_manager', 'logo_and_images', 'preloader', 'preferences',
                    'support_information', 'social_links', 'page_headings', 'language', 'payment_gateways',
                    'email_settings', 'plugins', 'seo_information', 'maintenance_mode', 'cookie_alert', 'sitemap',
                    'database_backup', 'clear_cache'])
                    {{-- Basic Settings --}}
                    <li
                        class="nav-item
          ...
          @elseif(request()->path() == 'admin/sitemap') active @endif">
            ...
            @elseif(request()->path() == 'admin/sitemap') show @endif"
                ...
                @elseif(request()->is('admin/language/*/edit/keyword')) active @endif">
                                ...
                                @endcan
                                @canany(['sitemap', 'database_backup', 'clear_cache'])
                                    <li
                                        class="
