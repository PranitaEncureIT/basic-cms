  ...
  @elseif(request()->path() == 'admin/contact') active @endif">
    ...
    @elseif(request()->path() == 'admin/contact') show @endif"
        ...
        <ul class="nav nav-collapse">
            ...
            @canany(['sections_customization', 'partners', 'bcategory','blogs', 'archives', 'team_section', 'testimonials', 'portfolios', 'add_portfolio', 'call_to_action_section', 'statistics_section', 'service_section' ,  'approach_section','settings_services', 'scategory', 'services', 'intro_section', 'features','static_version', 'slider_version', 'video_version', 'package_background'])
                {{-- Home Page Sections --}}
                <li
                    class="
        ...
        @elseif(request()->path() == 'admin/sections') selected @endif">
          ...
          @elseif(request()->path() == 'admin/sections') show @endif"
                        ...
                        <ul class="nav nav-collapse subnav">
                            @canany(['static_version', 'slider_version', 'video_version'])
                                <li
                                    class="
            ...
            @canany(['logo_and_text', 'useful_links', 'department_links', 'about_us'])
                {{-- Footer --}}
                <li
                    class="
        ...
        @elseif(request()->path() == 'admin/dlinks') selected @endif">
          ...
          @elseif(request()->path() == 'admin/ulinks') show
          @elseif(request()->path() == 'admin/alinks') show
          @elseif(request()->path() == 'admin/dlinks') show @endif"
                        id="footer">
                        <ul class="nav nav-collapse subnav">
                            @can('logo_and_text')
            ...
            @canany(['settings_services', 'scategory', 'services'])
                {{-- Service Management --}}
                <li
                    class="
        ...
        @elseif(request()->is('admin/portfolio/*/edit')) selected @endif">
          ...
          @elseif(request()->is('admin/portfolio/*/edit')) show @endif"
            ...
            @canany(['bcategory', 'blogs', 'archives'])
                {{-- Blogs Management --}}
                <li
                    class="
        ...
        @elseif(request()->is('admin/blog/*/edit')) selected @endif">
          ...
          @elseif(request()->is('admin/blog/*/edit')) show @endif"
            ...
            @canany(['gallery_settings', 'gallery_categories', 'gallery'])
                {{-- Gallery Management --}}
                <li
                    class="
        ...
        @elseif(request()->is('admin/gallery/*/edit')) selected @endif">
          ...
          @elseif(request()->path() == 'admin/gallery') show
          @elseif(request()->path() == 'admin/gallery/create') show
          @elseif(request()->is('admin/gallery/*/edit')) show @endif"
                        id="gallery">
                        <ul class="nav nav-collapse subnav">
                            @can('gallery_settings')
                            ...
                            @can('gallery')
                                <li
                                    class="@if (request()->path() == 'admin/gallery') active
              @elseif(request()->path() == 'admin/gallery/create') active
        ...
        @elseif(request()->path() == 'admin/faqs') selected @endif">
          ...
          @elseif(request()->path() == 'admin/faq/categories') show
          @elseif(request()->path() == 'admin/faqs') show @endif"
                        id="faq">
                        <ul class="nav nav-collapse subnav">
                            @can('faq_settings')
            ...
            @canany(['jcategories', 'post-job', 'job-management'])
                {{-- Career Page --}}
                <li
                    class="
