            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.slider.index') . '?language=' . request()->input('language') }}">
                        ...
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.slider.update') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    @php
                                        $imagePath = public_path('cms/slider/' . $slider->image);
                                    @endphp
                                    <div class="thumb-preview" id="thumbPreview1">
                                        @if (!empty($slider->image) && file_exists(public_path('cms/slider/' . $slider->image)))
                                            <img src="{{ asset('cms/slider/' . $slider->image) }}"
                                                alt="Image">
                                        @else
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="bold_text"
                                                    value="{{ $slider->bold_text }}" placeholder="Enter Bold Text">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control ltr" name="bold_text_font_size"
                                                    value="{{ $slider->bold_text_font_size }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control ltr" name="text_font_size"
                                                    value="{{ $slider->text_font_size }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="button_text_font_size"
