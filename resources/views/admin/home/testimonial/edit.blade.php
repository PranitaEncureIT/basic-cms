                ...
                <div class="card-body pt-5 pb-5">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.testimonial.update') }}"
                                method="post">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview" id="thumbPreview1">
                                        @if (!empty($testimonial->image) && file_exists(public_path('cms/testimonial/' . $testimonial->image)))
                                            <img src="{{ asset('cms/testimonial/' . $testimonial->image) }}"
                                                alt="Image">
                                        @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="rank"
                                        value="{{ $testimonial->rank }}" placeholder="Enter rank">
