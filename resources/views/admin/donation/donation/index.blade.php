                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal"
                                data-target="#createModal" style="color: white !important;"><i class="fas fa-plus"></i> Add
                                Cause</a>
                            <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete"
                                data-href="{{ route('admin.donation.bulk.delete') }}"><i class="flaticon-interface-5"></i>
                                Delete</button>
                        </div>
                    </div>
                </div>
                                            ...
                                            @foreach ($donations as $key => $donation)
                                                <tr>
                                                    ...
                                                    <td>{{ $bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : '' }}
                                                        {{ convertUtf8($donation->goal_amount) }}
                                                    ...
                                                    <td>{{ $bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : '' }}
                                                        {{ convertUtf8($donation->min_amount) }}
                                                        {{ $bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : '' }}
                                                    </td>

                                                    <td>
                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.donation.edit', $donation->id) . '?language=' . request()->input('language') }}">
                                                        ...
                                                        <form class="deleteform d-inline-block"
                                                            action="{{ route('admin.donation.delete') }}" method="post">
                                                            @csrf
                ...
                <div class="modal-body">
                    ...
                    <form id="ajaxForm" class="modal-form" action="{{ route('admin.donation.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-warning">Custom amount must be equal to or greater than minimum
                                amount</small>
                        </div>
                        <div class="form-group">
                            <label for="">Meta Keywords</label>
                            <input type="text" class="form-control" name="meta_tags" value=""
                                data-role="tagsinput">
                        </div>
                        <div class="form-group">
